...
public class ThinkliesAdapter extends RecyclerView.Adapter<ThinkliesAdapter.MyViewHolder> {
    private ArrayList<Thinklies> mList = new ArrayList<>();

    public ThinkliesAdapter(ArrayList<Thinklies> mList)
    {
        this.mList = mList;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (mList.get(position).getBody()!= null){
            ...
            holder.tv_body.setText(mList.get(position).getBostonTeaParty());
        }
